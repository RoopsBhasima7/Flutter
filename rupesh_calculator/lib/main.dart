...
class RPSCalculator extends StatefulWidget {
  @override
  _RPSCalculatorState createState() => _RPSCalculatorState();
}

class _RPSCalculatorState extends State<RPSCalculator> {
